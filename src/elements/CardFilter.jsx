...
const CardFilter = ({ searchValue, handleChange }) => {
    ...
    const statusOptions = [
        { key: 'l', text: 'Blocked', value: 'blocked' },
        { key: 'z', text: 'Active', value: 'active' },
    ]
                ...
                <Form>
                    <Form.Group widths='equal'>
                        ...
                        <Form.Field
                            ...
                            onChange={(e, { value }, type = "status") => handleChange(e, value?.toString(), type)}
